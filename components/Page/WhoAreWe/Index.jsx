    ...
    <section className="hero team-hero">
      <div className="pl-container">
        <div className="hero-text">
          <h1 className="big-2 w-900">Meet the Dream Team</h1>
          <p className="mt-5 lead-1">As travelers ourselves and developers, we are dedicated to delivering the next generation of travel search and discovery, fueled by our passion for innovation.</p>
        </div>
      </div>
    </section>
